...
// install it in the local hardhat project: npm install @chainlink/contracts --save-dev

contract FundMeSimple03{
    ...
    */
    ...
    modifier checkInWindowTime(){
         require(block.timestamp < deploymentTimestamp + lockTime, "Window is closed");
         _;
    }

    modifier checkNotInWindowClosed(){
        require(block.timestamp >= deploymentTimestamp + lockTime, "Window is not closed");
        _;
    }
